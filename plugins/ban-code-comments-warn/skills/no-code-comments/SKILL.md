...
The warn plugin allows the edit but adds concise guidance when it detects a newly introduced finding. Review the finding, remove the comment, or move the information to an approved documentation alternative.
