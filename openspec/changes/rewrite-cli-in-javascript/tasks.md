...
- [ ] 2.2 Move the checked-in language fixtures into the Node test layout and verify finding, clean, and false-positive fixtures cover every supported language and extension mapping.
...
- [ ] 2.4 Implement JSON and text reporting from the shared result model, and verify output field names, ordering, ranges, text, summaries, newline behavior, and writer failures.
